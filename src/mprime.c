...
/*   Updated: 2016/09/22 15:00:14 by abureau          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			set_proj_coord(t_coord *coord, t_fdf *map)
{
	...
	coord->dotp.x = ((map->params.eyes.z *
		(coord->dot.x - map->params.eyes.x)) / sec_div) + map->params.eyes.x;
	coord->dotp.y = ((map->params.eyes.z *
		(coord->dot.y - map->params.eyes.y)) / sec_div) + map->params.eyes.y;
}
